        ...
        children: [
              ...
              Positioned.fill(
                child: Align(
                  ...
                  child: Container(
                    ...
                    color: Colors.grey
                        .withOpacityValue(GlobalConstants.opacityLow),
                  ),
                ),
              ),
                      ...
                      : index == state.steps.length - 1
                          ? Expanded(
                              child: Row(
                                children: [
                                  Expanded(child: Container()),
                                  _buildStepCircle(context, index + 1, isActive,
                                      isCompleted),
                                ],
                              ),
                            )
          ...
          Row(
            ...
            children: state.steps.asMap().entries.map((entry) {
              ...
              final fontSize = itemWidth < 90
                  ? GlobalConstants.fontXS
                  : GlobalConstants.fontS;
  ...
  Widget _buildStepCircle(
    ...
    return Container(
      ...
      child: Center(
        child: isCompleted
            ? Icon(Icons.check,
                color: Colors.white, size: GlobalConstants.stepperIconSmallSize)
            : Text(
                '$stepNumber',
