...
class FCAOutlinedButton extends StatefulWidget {
  ...
  @override
  _FCAOutlinedButtonState createState() => _FCAOutlinedButtonState();
}

class _FCAOutlinedButtonState extends State<FCAOutlinedButton> {
